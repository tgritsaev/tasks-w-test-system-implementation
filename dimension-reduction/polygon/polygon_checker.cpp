...
const ld mul = 2;
const ld eps = 0.001 * 0.001 * 0.001;
...
int main(int argc, char *argv[]) {
  ...
  down_bounds[7] = 7010250.82184214245671682874672;
  down_bounds[8] = 491517.074038188302353091785335;
  down_bounds[9] = 133171.028020444858796622611408;
  //    = {0,      0,     0,        160,   2600,
  //                             120000, 11500, 87600000, 479000};
  vector<ld> up_bounds(10);
  for (int i = 0; i < 10; ++i) {
  ...
  //   up_bounds[1] = 120000;
  //   up_bounds[2] = 11500;
  //   up_bounds[3] = 2500 * 0.3;
  //   up_bounds[4] = 26484 * 0.3;
  //   up_bounds[5] = 19904074 * 0.20;
  //   up_bounds[6] = 2061010 * 0.20;
  //   up_bounds[7] = 8760000 * 5;
  //   up_bounds[8] = 75992401 * 0.20;
  //   up_bounds[9] = 19904074 * 0.20;
  //   = {300, 120000, 11500, 2500, 26484, 19904074, 2061010, 1152180326,
  //   75992401};
  for (size_t i = 0; i < up_bounds.size(); ++i) {
    up_bounds[i] *= mul;
  }
